...
from app.core.draft_guard import ensure_draft_allowed, inspect_draft
...
class BookPipeline:
    ...
    def run(
        ...
        draft = self._write_draft(meta, transcript, plan)
        ...
        return self._persist_outputs(request, meta, plan, draft, length_budget)
